...
INSERT INTO VIDEO(title, description, url, category_id) VALUES('CASIMIRO REAGE À RESPOSTA DE MARCELO CABO EM COLETIVA APÓS EMPATE COM O NÁUTICO | Cortes do Casimito', 'Live do dia 18/07/2021 para o dia 19/07/2021', 'https://youtu.be/0AylNJxkjCg', 3);
INSERT INTO VIDEO(title, description, url, category_id) VALUES('CASIMIRO VAI A LOUCURA COM REGRA DA CBF E DESAFIA ROGÉRIO CENI A SALVAR O VASCO | Cortes do Casimito', 'Live do dia 18/07/2021 para o dia 19/07/2021', 'https://youtu.be/GgLPAmbiLkE', 4);
